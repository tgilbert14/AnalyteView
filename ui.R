...
ui <- dashboardPage(skin = 'blue',
  ...
  dashboardSidebar(
      ...
      selectInput("Select_B", "Please select something to compare it to:",
                  choices = c('Discharge'='Discharge-FIELD','Domain ANC'='ANC-DOMAIN','Domain ALK'='ALK-DOMAIN','ANC','Br','Ca','Cl','CO3','Conductivity'='conductivity','DIC','DOC','F','Fe','HCO3','K','Mg','Mn','Na','NH4 - N','NO2 - N','NO3+NO2 - N','Ortho - P','pH','Si','SO4','TDN','TDP','TDS','TN','TOC','TP','TPC','TPN','TSS','TSS - Dry Mass','UV Absorbance (250 nm)','UV Absorbance (280 nm)'), selected = F, multiple = F),
